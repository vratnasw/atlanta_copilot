...
with col21:
    if st.button('Check Zoning Parameters', key=3, use_container_width=True):
        test = 1
        if test: 
                st.markdown(':gray[Zoning classification - [**R4**]](https://library.municode.com/ga/atlanta/codes/code_of_ordinances?nodeId=PTIIICOORANDECO_PT16ZO_CH6SIMIREDIRE)')
                st.markdown(':gray[Structure Type - [**Pass**]](https://library.municode.com/ga/atlanta/codes/code_of_ordinances?nodeId=PTIIICOORANDECO_PT16ZO_CH6SIMIREDIRE)')
                st.markdown(':gray[Pass/Fail - **Pass**] \n ')
                ...
                st.markdown(':gray[Min front setback - 35 ft]')
                st.markdown(' :gray[Front Setback - 40ft]')
                st.markdown(':gray[Pass/Fail - [**Pass**]](https://library.municode.com/ga/atlanta/codes/code_of_ordinances?nodeId=PTIIICOORANDECO_PT16ZO_CH6SIMIREDIRE_S16-06.007MILORE) ')
                ...
                st.markdown(':gray[Minimum off street parking - 1]')
                st.markdown(':gray[Off street parking - 2]')
                st.markdown(':gray[Pass/Fail - [**Pass**]](https://library.municode.com/ga/atlanta/codes/code_of_ordinances?nodeId=PTIIICOORANDECO_PT16ZO_CH6SIMIREDIRE_S16-06.010MIOREPARE)')
                ...
                st.markdown(':gray[Max Lot coverage - 35%]')
                st.markdown(':gray[Lot Coverage - 30%]')
                st.markdown(':gray[Pass/Fail - [**Pass**]](https://library.municode.com/ga/atlanta/codes/code_of_ordinances?nodeId=PTIIICOORANDECO_PT16ZO_CH6SIMIREDIRE_S16-06.007MILORE)')
...
prompt = st.chat_input("🧷 Please upload your site or construction plans.")
...
if submit:
        ...
        st.download_button(label="Download data as a text", data=text, file_name='output.docx', mime = 'docx') 
